    ...
    <S.Container>
      ...
      <S.ContentText>
        <div style={{ justifyContent: 'flex-end' }}>
          <p>
            No Strateegia você{' '}
            <span style={{ color: '#1568B0' }}>constrói</span> ideias e{' '}
            <span style={{ color: '#5B319E' }}>debate</span> colaborativamente,
            onde o <span style={{ color: '#EF6C00' }}>design</span> intuitivo
            encontra a transformação{' '}
            <span style={{ color: '#E1005E' }}>estratégica</span>.
          </p>
        </div>
        <div>
          <p>
            Discorra seus tópicos do Trello experimentando uma plataforma para
            <span style={{ color: '#007AFF' }}> criar</span>,{' '}
            <span style={{ color: '#CD3CB5' }}>evoluir</span> e{' '}
            <span style={{ color: '#5B319E' }}>adaptar</span> projetos e
            aprendizados para o{' '}
            <span style={{ color: '#FDB400' }}>futuro</span>.
          </p>
        </div>
